...
export async function downloadPhoto() {
    try {
       const res2 = await axios.get("http://localhost:3000/auth/register/randomPhoto?query=man,womam,people,portrait");
       console.log('the res2 of unsplah is: ' + JSON.stringify(res2));
       return { id: res2.data.id, url: res2.data.urls.full, downloadLocation: res2.data.links.download_location };
